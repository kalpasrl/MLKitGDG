package com.keridano.mlkit.imagelabeling
...
//        val labelDetector = FirebaseVision.getInstance().getOnDeviceImageLabeler(options)
        val labelCloudDetector = FirebaseVision.getInstance().getCloudImageLabeler(cloudOptions)

        labelCloudDetector.processImage(firebaseVisionImage)
